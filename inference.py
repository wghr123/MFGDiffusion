...
safetensors_file = "/home/qixinggroup/wgh123/Project/ModelTest/AblationModel/ResnetAblation/resnet152/checkpoint-3000/model.safetensors"
...
# 定义推理函数
def generate_image(prompt, num_inference_steps=50, guidance_scale=7.5, eta=0.0):
    # 初始化潜在变量
...
prompt = "A mountain and forest with smoke"
for i in range(0, 6):
    ...
    image_pil.save(f"/home/qixinggroup/wgh123/Project/ModelTest/data/output{i}.png")
